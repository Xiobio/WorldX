---
name: worldspark-overview
description: Maps WorldX architecture, ownership boundaries, create flows, runtime contracts, timeline system, and debugging entry points. Use when starting any WorldX task, deciding which subsystem owns a feature or bug, or orienting an agent before making changes.
---
# WorldX Overview
...
- Server simulation uses root `.env`; live simulation and generation read different env families (`LLM_*` vs `ARK_*`).
